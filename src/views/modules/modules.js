...
const Roles = () => {
  ...
  const usersData = [
    {id: 0, module: 'Dashboard', registered: '2018/01/01', role: 'Guest', status: 'Pending'},
    {id: 1, module: 'Users', registered: '2018/01/01', role: 'Member', status: 'Active'},
    {id: 2, module: 'Roles', registered: '2018/01/01', role: 'Member', status: 'Active'},
    {id: 3, module: 'Modules', registered: '2018/01/01', role: 'Member', status: 'Active'},
    {id: 4, module: 'Permissions', registered: '2018/01/01', role: 'Member', status: 'Active'},
  ]
  ...
  return(
    ...
    <CRow>
        <CCol>
          <CCard>
            <CCardHeader>
               <CTooltip content="Add Module">
                <CButton
                  size="sm"
                  className="btn-brand mr-1 mb-1"
                  color="primary"
                  onClick={() => history.push("/users/addmodule")}>
                      <CIcon name="cil-plus" /> Add Module
                </CButton>
              </CTooltip>
              <CTooltip content="Edit Module">
                      <CButton size="sm" className="btn-brand mr-1 mb-1" color="secondary" >
                        <CIcon name="cil-lock-unlocked" /> Edit Module
                      </CButton>
              </CTooltip>
                <div className="card-header-actions">
                  <CTooltip content="Delete Module">
                      <CButton size="sm" className="btn-brand mr-1 mb-1" color="danger" >
                        <CIcon name="cil-trash" /> Delete Module
                      </CButton>
                  </CTooltip>
                </div>
            </CCardHeader>
